...
function fight() {
    ...
    var promptFight = window.prompt("Would you like to FIGHT or SKIP this battle? Enter 'FIGHT' or 'SKIP' to choose."); var promptFight = window.prompt("Would you like to FIGHT or SKIP this battle? Enter 'FIGHT' or 'SKIP' to choose.");
}
...
console.log(
    ...
    + enemyName + " now has " + enemyHealth + " health remaning."
);
